...
import com.example.asaditasgourmet.ListaProductoCategoriaActivity;
 ...
 */
public class BuscarAdapter extends RecyclerView.Adapter<BuscarAdapter.MyViewHolder> implements Filterable {
    ...
    public BuscarAdapter(Context context, List<Categoria> notesList) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.linear1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, ListaProductoCategoriaActivity.class);
